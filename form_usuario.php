	...
	<div class="col-6 offset-3">
		...
		<form action="controle_usuario.php?acao=<?= ( $usuario->getId() != '' ? 'editar' : 'cadastrar' )?>" method="post">
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" name="telefone" id="telefone" required value="<?= ($usuario->getTelefone() != '' ? $usuario->getTelefone() : '') ?>">
			</div>
			<div class="form-group">
				<label for="nome">Endereço</label>
				<input type="text" name="text" id="endereco" class="form-control" required value="<?= ($usuario->getEndereco() != '' ? $usuario->getEndereco() : ''); ?>">
			</div>
			<div class="form-group">
