		...
		<tbody>
			...
			<tr>
				...
				<td>
					...
					<a href="controle_usuario.php?acao=removeImagem&id=<?= $usuario->getId() ?>" onclick="return confirm('Deseja realmente remover a imagem?')" class="btn btn-danger"><i class="fas fa-image"></i>
					</a>
				</td>
			</tr>
			<?php } ?>
